...
This project is for educational purposes only. All testing was conducted on:
...
**Note:** This project demonstrates security analysis skills for educational and professional development purposes. All findings are from controlled test environments.
